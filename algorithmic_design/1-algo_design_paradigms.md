...
### Greedy Algorithms
They involve optimization and combinatorial propblems, the classic example is applying it to the traveling salesperson problem, where a greedy approach always choose
